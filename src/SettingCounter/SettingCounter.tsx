    ...
    return (
        <div className={"counter"}>
            <div>
                ...
                <input className={inputSettingClass} value={0} onChange={onChangeStartValueHandler}
                       type="number"/>
            </div>

            <div>
                <span>Max Value</span>
                <input className={inputSettingClass} value={0} onChange={onChangeMaxValueHandler}
                       type="number"/>
            </div>
